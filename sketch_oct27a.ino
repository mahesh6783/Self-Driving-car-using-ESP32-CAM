...
<html>
  ...
  <tr><td colspan="3" align="center"><button class="button" onmousedown="toggleCheckbox('lighton');" ontouchstart="toggleCheckbox('lighton');" onmouseup="toggleCheckbox('lightoff');" ontouchend="toggleCheckbox('lightoff');">light</button></td></tr>    
   <script>
